var webApi = {
          ...
          GetExDataIndex: '/api/SzOpenData/GetExDataIndex?keywords={keywords}&tbzt={tbzt}&pageNum={pageNum}&pageSize={pageSize}', //获取外部数据索引; 方式:GET; 是否需要token:需要；参数说明:[keywords=》关键字；tbzt=》同步状态；pageNum=》页号；pageSize=》页大小；]
          },
          //文本分析接口。根据方法设置token
          TextAnalysis : { 
